  ...
  return (
    <footer className="bg-canva_nav">
      ...
      <div className="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8 text-whitee">
        ...
        <div className="mt-10 flex justify-center space-x-10 text-bg-whitee">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-gray-400 hover:text-gray-500 text-whitee"
            >
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500 text-whitee">
